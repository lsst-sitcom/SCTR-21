...
\label{sect:objectives}
 ...
 The objective of this test plan is to re-verify the hardware functional
requirements of the M2 hexapod, as well as verify the software
functional requirements of the M2 hexapod integrated with SAL 4.0. This
test campaign will exercise the functionality of the hardware that was
...
The hardware requirements were previously verified during the test
campaign by the vendor at the vendors facility and accepted by LSST
...
\label{sect:hwconf}
  The M2 Hexapod will be verified in a climate controlled environment on
the 3rd floor of the Summit Facility on the shipping/test plate.~
...
\toprule
\multicolumn{3}{l}{ Test Plan {\bf LVV-P68: M2 Hexapod Functional Re-verification and Integration with SAL 4.0 }} & Draft \\\hline

  \multicolumn{3}{l}{ Test Cycle {\bf LVV-C147: M2 Hexapod Re-verification and Integration Testing }} & Not Executed \\\hline
...
Re-verify the hardware for the M2 Hexapod that was previously tested by
MOOG and verify the integrated M2 hexapod with SAL 4.0~
...
attached \emph{LSST Hexapod Operator's Manual} for more information on
...
30 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
In enabled/stationary state, send a positionSet command of
({\textbf{VALID COMMAND}})
...
The objective of this test case is tor e-verify the functional
...
\item
  Only requires a laser tracker
\item
  Does NOT require the M2 hexapod to be loaded with an M2 simulated mass
\end{itemize}
...
\\ \cdashline{2-2}
 ...
 & Test Data \\
 & \begin{minipage}[t]{15cm}{\footnotesize
Deviation: Test at a single elevation angle and with no performance
payload.
...
3 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
3.5.15 Radial (X and Y) Translation Range
...
4 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
3.5.17 Axial (Z) Translation Range
...
5 & Description \\
 & \begin{minipage}[t]{15cm}
{\footnotesize
3.5.19 Rotational Range Around X-Axis (Tip) and Y-Axis (
...
\\ \cdashline{2-2}
 ...
 & Test Data \\
 & \begin{minipage}[t]{15cm}{\footnotesize
Allow a minimum of 30 seconds between moves
...
\\ \cdashline{2-2}
 ...
 & Test Data \\
 & \begin{minipage}[t]{15cm}{\footnotesize
Perform at single elevation angle
...
\\ \cdashline{2-2}
 ...
 & Test Data \\
 & \begin{minipage}[t]{15cm}{\footnotesize
Analyze data from 3.5.15, 3.5.17, and 3.5.19 test steps after testing to
verify cross talk
